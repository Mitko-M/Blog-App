        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: false, comment: "Post content"),
                    ShortDescription = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false, comment: "Post short description acting as intro to engage the reader to read more"),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Post creation date"),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Post last update date"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Application user and post creator identifier")
                },
                constraints: table =>
                {
