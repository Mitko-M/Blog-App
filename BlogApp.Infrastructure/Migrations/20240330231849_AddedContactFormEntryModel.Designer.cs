...
namespace BlogApp.Infrastructure.Migrations
{
    ...
    [Migration("20240330231849_AddedContactFormEntryModel")]
    partial class AddedContactFormEntryModel
    {
            ...
            modelBuilder.Entity("BlogApp.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "df40b32e-95c9-4535-b557-e61079177476",
                            AccessFailedCount = 0,
                            Banned = false,
                            ConcurrencyStamp = "256c1659-410b-4e69-b89b-38a7752fb23d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKFK5RK5iZyaOjYxCoXbo9mz+KlhyRVY/WR/RoN6IhqJlScqjWpXgNVK9vdUHcP16w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "fc644737-5ed7-4e29-bf49-388003426ee3",
            ...
            modelBuilder.Entity("BlogApp.Infrastructure.Data.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2019, 3, 31, 1, 18, 48, 656, DateTimeKind.Local).AddTicks(1396),
                            Hidden = false,
                            ShortDescription = "This is my post's short description",
                            Title = "My First Post",
                            UpdatedOn = new DateTime(2021, 9, 30, 1, 18, 48, 656, DateTimeKind.Local).AddTicks(1433),
                            UserId = "df40b32e-95c9-4535-b557-e61079177476"
                        },
                        new
                        {
                            Id = 2,
                            Content = "This is my second post's content",
                            CreatedOn = new DateTime(2019, 3, 31, 1, 18, 48, 656, DateTimeKind.Local).AddTicks(1441),
                            Hidden = false,
                            ShortDescription = "This is my post's short description",
                            Title = "My Second Post",
                            UpdatedOn = new DateTime(2023, 5, 31, 1, 18, 48, 656, DateTimeKind.Local).AddTicks(1443),
                            UserId = "df40b32e-95c9-4535-b557-e61079177476"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 1, 31, 1, 18, 48, 656, DateTimeKind.Local).AddTicks(1446),
                            Hidden = false,
                            ShortDescription = "This is my post's short description",
                            Title = "My Third Post",
                            UpdatedOn = new DateTime(2024, 3, 26, 1, 18, 48, 656, DateTimeKind.Local).AddTicks(1448),
                            UserId = "df40b32e-95c9-4535-b557-e61079177476"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "858b981e-afdd-4520-9676-fd6884516024",
                            Name = "Admin",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "e11c2432-af3f-40a6-a477-4a059c764218",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
